        ...
        <div class="demo-content">
            ...
            <div class="row">
                <form ng-submit="addAddressBook(ab)">
                    <div class="col-lg-8">
                        <input type="hidden" ng-model="ab.userId"/>
                        <input class="form-control" placeholder="Enter Name" type="text" ng-model="ab.userName" required min="1" />
                        <input class="form-control" placeholder="Enter Phone" type="text" ng-model="ab.phoneNumber" required min="1" />
            ...
            <table class="table table-bordered table-striped" ng-show="addressBooks.length > 0">
                ...
                <tr>
                    ...
                    <th style="text-align: center;"><a href="" ng-click="reverse=!reverse;order('userName', reverse)">User Name</a></th>
                    <th style="text-align: center;"><a href="" ng-click="reverse=!reverse;order('phoneNumber', reverse)">Phone Number</a></th>
                ...
                <tr ng-repeat="addressBook in addressBooks | filter:searchAddressBook">
                    <td  style="width:70px;text-align:center;"><button class="btn btn-mini btn-danger" ng-click="deleteAddressBook(addressBook.userId)">Delete</button></td>
                    <td  style="width:70px;text-align:center;"><button class="btn btn-mini btn-danger" ng-click="editAddressBook(addressBook.userId, addressBook)">Update</button></td>
                    <td>{{addressBook.userName}}</td><td>{{addressBook.phoneNumber}}</td><td>{{addressBook.email}}</td>
                </tr>
                </tbody>
            </table>
